...
class L10nNoMvameldingMerknad(models.Model):
    ...
    _constraint_beskrivelse = models.Constraint(
        # Tegnsettet er eksplisitt: btrim() uten argument trimmer KUN
        # mellomrom, så en beskrivelse på "\n" ville passert og gitt et
        # tomt <beskrivelse>-element som R021 ikke godtar.
        "CHECK (btrim(beskrivelse, E' \\t\\n\\r') <> '')",
